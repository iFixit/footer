...
import { StoreDropdown, LanguageDropdown, StoreFlag } from '@ifixit/product-page-components';
...
export const StyledStoreDropdown = styled(StoreDropdown)`
                  ...
                  >
                     <Grid templateColumns="repeat(3, 1fr)" gap={space[4]}>
                        <FooterLink href="#">
                           <FooterPartner
                              alt="Partner logo"
                              source="https://uploads-ssl.webflow.com/5c9b91208becd3baee84a04b/5f9875573388ede7e3f1c9a0_logo-visa.png"
                           />
                        </FooterLink>
                        <FooterLink href="#">
                           <FooterPartner
                        ...
                        <FooterLink href="#">
                           <FooterPartner
                              alt="Partner logo"
                              source="https://uploads-ssl.webflow.com/5c9b91208becd3baee84a04b/5f9875565af2ab6da22d5134_logo-hermes.png"
                           />
                        </FooterLink>
                        <FooterLink href="#">
                           <FooterPartner
               ...
               >
                  <GridItem justify={{ base: 'center', lg: 'start' }}>
                     <Stack spacing={space[8]}>
                        <Popover defaultIsOpen stores={stores}>
                           <PopoverTrigger>
                              <DropdownTrigger>
                                 Region
                                 <DropdownTriggerTag>
                                    <StoreFlag storeCode={'us'} />
                                 </DropdownTriggerTag>
                              </DropdownTrigger>
                           </PopoverTrigger>
                           <PopoverContent>
                        ...
                        <Popover stores={stores}>
                           <PopoverTrigger>
                              <DropdownTrigger>
                                 Language
                                 <DropdownTriggerTag>EN</DropdownTriggerTag>
                              </DropdownTrigger>
                           </PopoverTrigger>
                           <PopoverContent>
